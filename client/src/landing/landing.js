...
export default class Landing extends React.Component{
    ...
    render(){
        return(
            <div>
              <div class="carousel">
                <a class="carousel-item" href="#one!"><img src='https://images.unsplash.com/photo-1454789548928-9efd52dc4031?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1400&q=80'/></a>
                ...
                <a class="carousel-item" href="#three!"><img src='https://images.unsplash.com/photo-1454789548928-9efd52dc4031?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1400&q=80'/></a>
